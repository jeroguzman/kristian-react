...
const Hero = () => {
  return (
    <section className="pt-24 bg-white mt-2">
        ...
        <div className="w-full mx-auto mt-20 text-center md:w-10/12">
            <div className="relative z-0 w-full mt-8">
                <div className="relative overflow-hidden shadow-2xl">
                    ...
                    <img src="https://cdn.devdojo.com/images/march2021/green-dashboard.jpg" alt="" className="object-cover w-full h-96 rounded-xl" />
                </div>
            </div>
        </div>
    </div>
